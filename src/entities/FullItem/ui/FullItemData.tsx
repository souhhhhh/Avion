...
export const FullItemData = observer(() => {
	...
	return (
		product ? (
			<div className='flex justify-center mt-10 font-Satoshi'>
				<div className='flex mt-10'>
					...
					<div className='p-10  ml-16 mt-14'>
						...
						<div>
							<p className=' font-normal text-xl mt-16 mb-10 font-ClashDisplay text-purple-light'>
								Description
							</p>
						...
						<div>
							...
							<div className='mt-10 flex gap-10'>
								...
								<Button theme={ButtonTheme.WHITE} onClick={() => addToLikes(product)}>Add to favorites</Button>
							</div>
						</div>
					</div>
				</div>
